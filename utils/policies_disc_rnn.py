...
class BasePolicy(nn.Module):
    ...
    def __init__(self, input_dim, out_dim, hidden_dim=64, nonlin=F.leaky_relu,
        ...
        self.fc1 = nn.Linear(input_dim + onehot_dim, args.rnn_hidden_dim)
    ...
    def forward(self, X, hidden_state):
        ...
        h2 = self.nonlin(self.rnn(h1, hidden_state))
        out = self.fc3(h2)
        return out
...
class BasePolicyNoFC3(nn.Module):
    """
    Base policy network
    """
    def __init__(self, input_dim, out_dim, hidden_dim=64, nonlin=F.leaky_relu,
        ...
        Inputs:
            ...
            nonlin (PyTorch function): Nonlinearity to apply to hidden layers
        """
        super(BasePolicyNoFC3, self).__init__()
