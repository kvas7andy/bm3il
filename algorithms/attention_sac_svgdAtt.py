...
class AttentionSAC(object):
    ...
    def __init__(self, agent_init_params, sa_size,
                 ...
                 reward_scale=10.,
                 pol_hidden_dim=128,
                 critic_hidden_dim=128, attend_heads=4, attend_dim=4,
        ...
        self.critic = AttentionCritic(sa_size, hidden_dim=critic_hidden_dim,
                                      attend_heads=attend_heads,attend_dim=attend_dim)
    ...
    def init_from_env(cls, env, gamma=0.95, tau=0.01,
                      ...
                      reward_scale=10.,
                      pol_hidden_dim=128, critic_hidden_dim=128, attend_heads=4, attend_dim=4, policy_contain_mask=False, observation_discrete=False,
                      **kwargs):
        """
