...
from utils.agents_svgdPolicy import AttentionAgent
from utils.critics_svgdQ import AttentionCritic
...
class AttentionSAC(object):
    ...
    def __init__(self, agent_init_params, sa_size,
        ...
        self.agents = [AttentionAgent(lr=pi_lr,
                                      ...
                                      pol_net_nums=pol_net_nums,
                                      **params)
                         for params in agent_init_params]
        self.critic = AttentionCritic(sa_size, hidden_dim=critic_hidden_dim,
                                      critic_net_nums=critic_net_nums, attend_heads=attend_heads)
    ...
    def update_critic(self, sample, soft=True, logger=None, **kwargs):
        ...
        # svgd attention gradient
        self.critic.svgd_att_grads()
        
        # svgd q gradient
        self.critic.svgd_q_grads()
        self.critic.scale_q_grads()
    ...
    def update_policies(self, sample, soft=True, logger=None, **kwargs):
        ...
        for a_i, probs, log_pi, pol_regs, (q, all_q) in zip(range(self.nagents), all_probs,
            ...
            # svgd policy gradient
            curr_agent.policy.svgd_policy_grads()
            curr_agent.policy.scale_policy_grads()
    ...
    def init_from_env(cls, env, gamma=0.95, tau=0.01,
                      ...
                      reward_scale=10.,
                      pol_hidden_dim=128, critic_hidden_dim=128, pol_net_nums=4, critic_net_nums=4, attend_heads=4, policy_contain_mask=False, observation_discrete=False,
                      **kwargs):
        """
        ...
        init_dict = {'gamma': gamma, 'tau': tau,
                     ...
                     'pol_net_nums': pol_net_nums,
                     'critic_net_nums': critic_net_nums,
