...
class AttentionSAC(object):
    ...
    def __init__(self, agent_init_params, sa_size,
                 ...
                 reward_scale=10.,
                 pol_hidden_dim=128,
                 critic_hidden_dim=128, pol_net_nums=4, attend_heads=4,
    ...
    def init_from_env(cls, env, gamma=0.95, tau=0.01,
                      ...
                      reward_scale=10.,
                      pol_hidden_dim=128, critic_hidden_dim=128, pol_net_nums=4, attend_heads=4, policy_contain_mask=False, observation_discrete=False,
                      **kwargs):
        """
