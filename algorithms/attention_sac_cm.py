...
from utils.critics_multiType import AttentionCritic
...
class AttentionSAC(object):
    ...
    def analyze_attention(self, sample, soft=True, logger=None, **kwargs):
        """
        ...
        critic_rets = self.critic(critic_in, return_attend=True)
        q_loss = 0
